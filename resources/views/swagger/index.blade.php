  ...
  <script type="text/javascript">
    $(function () {
      ...
      function addApiKeyAuthorization(){
        ...
        if(key && key.trim() != "") {
          var apiKeyAuth = new SwaggerClient.ApiKeyAuthorization("USER-TOKEN", key, "header");

          window.swaggerUi.api.clientAuthorizations.add("USER-TOKEN", apiKeyAuth);
            log("added key " + key);
        }
      }
